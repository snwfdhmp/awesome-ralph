...
- [Ariadne Loop](https://github.com/zhangzeyu99-web/ariadne-loop) - Loop Engineering CLI and workbench for verifiable AI coding-agent loop specs, backpressure gates, handoff packets, and JSON reports.
